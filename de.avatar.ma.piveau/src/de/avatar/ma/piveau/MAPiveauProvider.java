...
import de.avatar.ma.mimetypes.api.SupportedMediatype;

import org.gecko.emf.osgi.annotation.require.RequireEMF;
import org.gecko.piveau.api.DatasetProvider;
import org.gecko.piveau.api.DistributionProvider;
import org.gecko.piveau.api.PiveauRegistry;
import org.gecko.piveau.api.RDFHelper;
import org.gecko.piveau.api.config.DatasetConfig;
import org.gecko.piveau.dcat.Dataset;
import org.gecko.piveau.dcat.Distribution;

/**
 * MA Implementation to provide Distribution instances
 *
 * @author Mark Hoffmann
 * @since 12.12.2022
 */
@Component(name = "MAPiveauProvider", immediate = true, service = { DistributionProvider.class,
		DatasetProvider.class }, property = "piveau.provider=MA", configurationPolicy = ConfigurationPolicy.REQUIRE)
@RequireEMF
public class MAPiveauProvider implements DistributionProvider, DatasetProvider {
	...
	@Activate
	public MAPiveauProvider(DatasetConfig config, ComponentContext ctx, @Reference SupportedMediatype mediaTypes) {
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.gecko.piveau.api.DistributionProvider#canHandleDistribution(java.lang.
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.gecko.piveau.api.DistributionProvider#getDistributionConfig(java.lang.
	 * Object, java.util.Map)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.gecko.piveau.api.DatasetProvider#canHandleDataset(java.util.Map)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.gecko.piveau.api.DatasetProvider#createDataset(java.util.Map)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.gecko.piveau.api.DatasetProvider#getDatasetId()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.gecko.piveau.api.DatasetProvider#getCatalogueId()
	 */
	@Override
	...
	private Distribution[] updateEndpointInformation(Map<String, Object> distributionMap, String modelName,
		...
		if (jaxRS && modelName != null) {
			distributionMap.put("distribution.title", "MA REST for model '" + modelName + "'");
			...
			if (root != null) {
				...
				instanceProps.put("distribution.title",
						"MA REST endpoint for instances of '" + root + "' for model '" + modelName + "'");
			...
			distributionMap.put("distribution.title", "MA GraphQL for model '" + modelName + "'");
...
//				}
	...
	private boolean isGraphQL(Map<String, Object> referenceProperties) {
		Object object = referenceProperties.get("ma.graphql");
		return object == null ? false : Boolean.parseBoolean(object.toString());
	}
	 ...
	 *
	 * @see
	 * org.gecko.piveau.api.DistributionProvider#getEndpointUrl(java.util.Dictionary,
	 * org.gecko.piveau.api.config.DistributionConfig)
	 */
