...
import de.avatar.ma.graphql.query.MAGraphQLQueryProvider;
...
public class GraphQLEPackageConfigurator {
	...
	protected void bindEPackage(EPackage ePackage, Map<String, Object> properties) throws IOException {
		...
		Configuration queryProviderConfig = configAdmin.createFactoryConfiguration(MAGraphQLQueryProvider.MA_GRAPH_QL_QUERY_PROVIDER, "?");
		configList.add(queryProviderConfig);
		
		Dictionary<String, Object> props = new Hashtable<String, Object>();
		props.put(MAGraphQLQueryProvider.EPACKAGE_REFERENCE_NAME + ".target", "(" + EMFNamespaces.EMF_MODEL_NSURI + "=" + ePackage.getNsURI() + ")");
