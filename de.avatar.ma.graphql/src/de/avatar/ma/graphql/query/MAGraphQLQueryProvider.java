 ...
 */
package de.avatar.ma.graphql.query;
...
import de.avatar.ma.graphql.query.datafetcher.AllDataFetcher;
import de.avatar.ma.graphql.query.datafetcher.ByIdDataFetcher;
 ...
 * @since 22 Jun 2022
 */
@Component(name = MAGraphQLQueryProvider.MA_GRAPH_QL_QUERY_PROVIDER, immediate = true, configurationPolicy = ConfigurationPolicy.REQUIRE)
public class MAGraphQLQueryProvider implements GraphQLQueryProvider, GraphQLTypesProvider {

	/** E_PACKAGE */
	public static final String EPACKAGE_REFERENCE_NAME = "ePackage";

	/** MA_GRAPH_QL_QUERY_PROVIDER */
	public static final String MA_GRAPH_QL_QUERY_PROVIDER = "MAGraphQLQueryProvider";
