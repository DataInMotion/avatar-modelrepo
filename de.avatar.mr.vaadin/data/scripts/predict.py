...
cosine_dist_threshold_path = base_path + 'cos_dist_threshold.json'
...
loaded_threshold = loadJson(cosine_dist_threshold_path)
...
for feature_name, test_set in data.items():
	...
	predictionsDict[feature_name] = computePredictions(test_set, vectorized_test, vectorized_train, loaded_threshold)
