 ...
 */
package org.gecko.piveau.skos.configuration;
...
import org.gecko.piveau.skos.SkosFactory;
import org.gecko.piveau.skos.SkosPackage;

import org.gecko.piveau.skos.impl.SkosPackageImpl;

import org.gecko.piveau.skos.util.SkosResourceFactoryImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.piveau.skos.util.SkosResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource.Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,org.gecko.piveau.skos.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.piveau.skos.SkosFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,org.gecko.piveau.skos\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.piveau.skos.SkosPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,org.gecko.piveau.skos\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.gecko.piveau.skos\"" })
