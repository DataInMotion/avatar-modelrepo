 ...
 */
package org.gecko.piveau.adms.configuration;
...
import org.gecko.piveau.adms.AdmsFactory;
import org.gecko.piveau.adms.AdmsPackage;

import org.gecko.piveau.adms.impl.AdmsPackageImpl;

import org.gecko.piveau.adms.util.AdmsResourceFactoryImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.piveau.adms.util.AdmsResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource.Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,org.gecko.piveau.adms.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.piveau.adms.AdmsFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,org.gecko.piveau.adms\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.piveau.adms.AdmsPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,org.gecko.piveau.adms\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.gecko.piveau.adms\"" })
