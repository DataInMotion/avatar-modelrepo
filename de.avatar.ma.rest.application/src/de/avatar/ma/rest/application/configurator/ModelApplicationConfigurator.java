 ...
 */
package de.avatar.ma.rest.application.configurator;
...
import de.avatar.ma.rest.application.MAApplication;
import de.avatar.ma.rest.application.resource.DocumentationResource;
import de.avatar.ma.rest.application.resource.ModelResource;
import de.avatar.ma.rest.application.resource.openapi.OpenApiResource;
import de.avatar.ma.swagger.application.SwaggerIndexFilter;
import de.avatar.ma.swagger.application.SwaggerResources;
import de.avatar.ma.swagger.application.SwaggerServletContextHelper;
import de.avatar.ma.model.documentation.provider.ModelDocumentationProvider;
...
public class ModelApplicationConfigurator {
	...
	protected void bindEPackage(EPackage ePackage, Map<String, Object> properties) throws IOException {
		try {
			...
			modelResourceProperties.put(ModelResource.REPO_REFERENCE_NAME + ".target", "(repo_id=ma.ma)");
			...
			props.put(HttpWhiteboardConstants.HTTP_WHITEBOARD_CONTEXT_SELECT, "(" + HttpWhiteboardConstants.HTTP_WHITEBOARD_CONTEXT_NAME + "="
					+ swaggerContextNameHelper + ")");
			props.put("path", "/ma" + swaggerAppBasePath);
