/*
 */
package de.avatar.ma.model.system.configuration;

import de.avatar.ma.model.system.SystemFactory;
import de.avatar.ma.model.system.SystemPackage;

import de.avatar.ma.model.system.impl.SystemPackageImpl;

import de.avatar.ma.model.system.util.SystemResourceFactoryImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"de.avatar.ma.model.system.util.SystemResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource.Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,de.avatar.ma.model.system.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"de.avatar.ma.model.system.SystemFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,de.avatar.ma.model.system\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"de.avatar.ma.model.system.SystemPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,de.avatar.ma.model.system\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.avatar.ma.model.system\"" })
