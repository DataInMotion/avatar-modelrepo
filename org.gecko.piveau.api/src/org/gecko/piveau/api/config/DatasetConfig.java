 ...
 */
package org.gecko.piveau.api.config;
...
public @interface DatasetConfig {
	...
	String localBaseUri() default "http://0.0.0.0:8085/ma";
	...
	@AttributeDefinition(description = "Host name of the model atlas system (frontend view)")
